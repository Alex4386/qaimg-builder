...
# more room than the upstream cloud image ships. AlmaLinux uses an xfs root,
# which resize-image.sh grows via xfs_growfs. Override/disable with IMAGE_RESIZE=0.
